...
#$ -o master_Ridge_2.output #This is where your output and errors are logged.
...
spark-submit --driver-memory 32G /home/acq18mk/master/short_notebooks/2_1_tuning_Ridge.py

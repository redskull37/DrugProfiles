...
#$ -o master_tuning_svr.output #This is where your output and errors are logged.
...
spark-submit --driver-memory 32G /home/acq18mk/master/short_notebooks/8_tuning_svr.py

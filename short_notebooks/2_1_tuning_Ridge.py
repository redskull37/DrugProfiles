...
splitter_loo = LeaveOneOut()
grid = GridSearchCV(Ridge(), param_grid=param_grid, cv=splitter_loo)
...
for drug_id in drug_ids_50:
    ...
    for i, data_set in list(enumerate(datasets)):
        ...
        results.loc[drug_id, "best_solver" + str(i)] = grid.best_params_["solver"]
...
results.to_csv(_FOLDER+"ridge_coef1.csv")
...
results.to_csv(_FOLDER+"ridge_coef2.csv")
...
results.to_csv(_FOLDER+"ridge_coef3.csv")
...
results.to_csv(_FOLDER+"ridge_coef4.csv")
...
#$ -o master_svr_sigmoid.output #This is where your output and errors are logged.
...
spark-submit --driver-memory 32G /home/acq18mk/master/short_notebooks/8_svr_sigmoid.py

...
results.to_csv(_FOLDER+"all_Linear_SVR_coef2.csv")
...
results.to_csv(_FOLDER+"all_Sigmoid_SVR_coef2.csv")
...
results.to_csv(_FOLDER+"all_RBF_SVR_coef2.csv")
...
results.to_csv(_FOLDER+"all_Polynomial_SVR_coef2.csv")
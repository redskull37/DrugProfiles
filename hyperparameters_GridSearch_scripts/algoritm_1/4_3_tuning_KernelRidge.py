...
results.to_csv(_FOLDER+"all_Linear_KernelRidge_coef3.csv")
...
results.to_csv(_FOLDER+"all_Sigmoid_KernelRidge_coef3.csv")
...
results.to_csv(_FOLDER+"all_RBF_KernelRidge_coef3.csv")
...
results.to_csv(_FOLDER+"all_PolynomialKernelRidge_coef3.csv")
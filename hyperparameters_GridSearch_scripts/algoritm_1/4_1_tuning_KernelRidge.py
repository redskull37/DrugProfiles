...
grid = GridSearchCV(KernelRidge(kernel= "linear"), param_grid=param_grid, cv=splitter_loo, scoring= "neg_mean_absolute_error")
...
results.to_csv(_FOLDER+"all_Linear_KernelRidge_coef1.csv")
...
splitter_loo = LeaveOneOut()
grid = GridSearchCV(KernelRidge(kernel = "sigmoid"), param_grid = param_grid, cv = splitter_loo, scoring= "neg_mean_absolute_error")
...
results.to_csv(_FOLDER+"all_Sigmoid_KernelRidge_coef1.csv")
...
splitter_loo = LeaveOneOut()
grid = GridSearchCV(KernelRidge(kernel = "rbf"), param_grid = param_grid, cv = splitter_loo, scoring= "neg_mean_absolute_error")
...
results.to_csv(_FOLDER+"all_RBF_KernelRidge_coef1.csv")
...
results.to_csv(_FOLDER+"all_PolynomialKernelRidge_coef1.csv")
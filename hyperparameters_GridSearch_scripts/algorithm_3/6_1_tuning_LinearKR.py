...
param_tested_alphas = [0.1, 1, 5, 10, 100, 500]
param_grid = dict(alpha = param_tested_alphas)

splitter_loo = LeaveOneOut()
grid = GridSearchCV(KernelRidge(kernel= "linear"), param_grid=param_grid, 
                    cv=splitter_loo, scoring= "neg_mean_absolute_error")

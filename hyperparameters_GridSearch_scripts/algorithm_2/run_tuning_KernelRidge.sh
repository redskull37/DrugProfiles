...
#$ -o master_SVR_2.output #This is where your output and errors are logged.
...
spark-submit --driver-memory 64G /home/acq18mk/master/short_notebooks/2_3_tuning_SVR.py
